...
%\pagestyle{headings}  % switches on printing of running heads
    ...
    \title{CoSoCo 2.6\\ {\small XCSP3 Competition 2026}}
...
%\begin{document}
    ...
    This is the eight participation of CoSoCo to XCSP competitions.
    ...
    \begin{itemize}
        \item A compact table propagation engine \cite{DHLPPRS_efficiently}.
        \item Some new propagators (Cumulative, sum on boolean).
        \item No complete restars after solutions (for COP).
        \item An improvement of the parallel engine.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item v2: {\tt -var=wdeg -restarts=io -stick=1 -val=robin}
        \end{itemize}
        \item COP/Fast COP
        \begin{itemize}
            \item {\bf v1}: {\tt -var=robin -restarts=io -val=max -nr=1}
            \item v2: {\tt -rr=1 -nr=1}
        \end{itemize}
        \item Parallel COP
        \begin{itemize}
