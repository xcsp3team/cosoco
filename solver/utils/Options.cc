...
namespace Cosoco {
    namespace options {
        ...
        void createOptions() {
            ...
            intOptions["postponesize"] = {
                "CONSTRAINTS", "The size of postponed constraints (0=no postponed constraints)", 100, 0,
                INT_MAX
            };
            intOptions["i2e"] = {
                "PARSE", "Transform intension to extension. Max size of cartesian product (0 -> disable it)", 100000, 0,
                INT_MAX
            };
            ...
            boolOptions["bs"] = {"OPT", "Enable progress saving (only after a new solution)", true};
            boolOptions["soft_restarts"] = {"OPT", "Soft restarts after a solution", false};
