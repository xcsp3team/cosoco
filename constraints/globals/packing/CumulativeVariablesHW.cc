...
CumulativeVariablesHW::CumulativeVariablesHW(Problem &p, vec<Variable *> &vars, vec<Variable *> &w, vec<Variable *> &h, int limit)
    : Cumulative(p, vars, Constraint::createScopeVec(&vars, &w, &h), wwidths, wheights, limit) {
