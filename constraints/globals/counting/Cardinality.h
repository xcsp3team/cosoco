...
#include "constraints/globals/comparison/structures/Matcher.h"
...
class Cardinality : public GlobalConstraint {
   public:
    ...
    Cardinality(Problem &p, std::string n, vec<Variable *> &vars, vec<int> &v, vec<int> &min,
                vec<int> &max);                                                                     // Min and max occurences
